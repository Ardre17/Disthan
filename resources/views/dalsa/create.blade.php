...
<div class="erp-bar">
    <div class="erp-bar-left">
        ...
        <div class="erp-module">Registrar llegada — Dalsa</div>
    </div>
    <span style="font-size:11px;color:#5a8abf;">Logística › Dalsa › Nueva llegada</span>
</div>
...
<div class="page-hdr">
    <div>
        ...
        <div style="font-size:11px;color:#64748b;margin-top:2px;">
            Nueva entrada al almacén Dalsa
        </div>
    </div>
    <span style="font-size:11px;color:#94a3b8;">📦 Dalsa › Nueva llegada</span>
</div>
...
<form method="POST" action="{{ route('dalsa.store') }}">
@csrf
...
<div>
        ...
        <div class="sec-body">
            <div class="field">
                ...
                <span class="field-hint">
                    Cantidad exacta de cajas que llegan al almacén Dalsa
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="btn-row">
        <button type="submit" class="btn-save">📦 Registrar llegada</button>
        <a href="{{ route('dalsa.index') }}" class="btn-cancel">✕ Cancelar</a>
    </div>
...
<div>
    <div class="side-card">
        ...
        <div class="side-body">
            <div class="flow-item">
                ...
                <div>Se crea la mercadería en el almacén Dalsa con el stock inicial ingresado.</div>
            </div>
            <div class="flow-item">
    ...
    <div class="side-card" style="border-color:#fde68a;background:#fffbeb;">
        ...
        <div class="side-body">
            <div class="warn-item">
                <span>🎯</span>
                <div>Verifica la <strong>cantidad exacta</strong> de cajas antes de guardar.</div>
            </div>
            <div class="warn-item">
                <span>📋</span>
