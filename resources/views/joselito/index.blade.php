...
<div class="erp-bar">
    <div class="erp-bar-left">
        ...
        <div class="erp-module">Almacén Joselito</div>
    </div>
    <span style="font-size:11px;color:#5a8abf;">Logística › Joselito</span>
</div>
...
<div class="page-hdr">
    <div>
        <div class="page-title">Almacén Joselito</div>
        <div class="page-sub">Mercadería en tránsito de provincia · Solo ítems con stock activo</div>
    </div>
    <a href="{{ route('joselito.create') }}" class="btn-new">
        📦 Registrar llegada
    </a>
</div>
...
<div class="item-card"
    ...
    <div class="item-body">
        ...
        <div class="meta-tags">
            <span class="meta-tag tag-origen">
                🗺️ {{ $item->origen }}
            </span>
    ...
    <div class="item-footer">
        <a href="{{ route('joselito.show', $item) }}" class="btn-sm btn-kardex">
            📋 Kardex / Movimientos
        </a>
    </div>
</div>
